...
$baseUrl = "https://nof1-v220-api-qa.azurewebsites.net/";
...
$cmd | Out-File RefreshQaSsis.bat -Width 2000 -Encoding ascii;
"pause" | Out-File RefreshQaSsis.bat -Width 2000 -Append -Encoding ascii;

Start-Process RefreshQASsis.bat -Verb runAs;
$endDate = (GET-DATE);
$elapsedTime = NEW-TIMESPAN -Start $startDate -End $endDate
...
LogWrite ("Elapsed Time for RefreshQA: " + $elapsedTime);
